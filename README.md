...
char ssid[] = "VivoY285G"; //SSID

char pass[] = "12348765"; // Password
...
unsigned long myChannelField = 2755083; // Channel ID

const int ChannelField = 1; // Which channel to write data

const char * myWriteAPIKey = "93RWZ6OFXWKZPO61"; // Your write API Key
...
![Screenshot 2024-12-30 083106](https://github.com/user-attachments/assets/0497784e-04f1-4fae-8605-ac2a96031adb)

# OUTPUT:

![Screenshot 2024-12-30 083114](https://github.com/user-attachments/assets/692c8243-aff7-4459-817b-6fe1e45ac449)
